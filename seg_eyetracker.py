...
class SegEyetracker:
    ...
    def SetTime(self):
        ...
        self.eyetrackerVideo = os.path.join(self.athlete.folder.ori,"eyetracker","1.mp4")
        self.eyetrackerGaze = os.path.join(self.athlete.folder.ori,"eyetracker","1.txt")
    ...
    def RunSeg(self):
        ...
        txt_file = open(self.EyetrackerTime, 'r')
        next(txt_file)
        ...
        for i in range(len(self.eyetracker_seg_index)):
            ...
            file_writer = open(file=txt_name, mode="w")
            # globals()[new_txt_name] = open(file=txt_name, mode="w")
            line_num = 0
            with open(file=self.eyetrackerGaze, mode="r") as f_eyetracker_gaze:
