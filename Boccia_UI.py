...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.image_label_21 = QtWidgets.QLabel(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.image_label_21.sizePolicy().hasHeightForWidth())
        self.image_label_21.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(48)
        self.image_label_21.setFont(font)
        self.image_label_21.setStyleSheet("")
        self.image_label_21.setObjectName("image_label_21")
        self.verticalLayout.addWidget(self.image_label_21)
...
"    padding: 10px;}")
    ...
    def retranslateUi(self, Form):
        ...
        self.image_label_21.setText(_translate("Form", "handwriting view"))
        ...
        self.pushButton1.setText(_translate("Form", "Start Collecting"))
